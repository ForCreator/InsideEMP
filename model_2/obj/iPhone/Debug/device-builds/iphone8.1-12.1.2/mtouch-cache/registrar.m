...
@implementation UIApplicationDelegate {
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x14B04);
		if (call_super && rv) {
...
@implementation Foundation_NSDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, 0x1B204);
	}
...
@implementation __MonoMac_NSSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x19804);
	}
@end
...
@implementation Foundation_NSAsyncDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x19A04);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x19904);
		if (call_super && rv) {
...
@implementation __MonoMac_NSAsyncSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x19C04);
	}
@end
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, 0x1D904);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x1D704);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		{ NULL, 0x5704 /* #0 'NSObject' => 'Foundation.NSObject, Xamarin.iOS' */ },
		{ NULL, 0x4404 /* #1 'UIApplicationDelegate' => 'UIKit.UIApplicationDelegate, Xamarin.iOS' */ },
		{ NULL, 0x4504 /* #2 'UIResponder' => 'UIKit.UIResponder, Xamarin.iOS' */ },
		{ NULL, 0x4204 /* #3 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */ },
		{ NULL, 0x3F04 /* #4 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */ },
		{ NULL, 0x4104 /* #5 'UIView' => 'UIKit.UIView, Xamarin.iOS' */ },
		{ NULL, 0x4304 /* #6 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */ },
		{ NULL, 0x4704 /* #7 'NSArray' => 'Foundation.NSArray, Xamarin.iOS' */ },
		{ NULL, 0x4A04 /* #8 'NSNull' => 'Foundation.NSNull, Xamarin.iOS' */ },
		{ NULL, 0x4B04 /* #9 'NSRunLoop' => 'Foundation.NSRunLoop, Xamarin.iOS' */ },
		{ NULL, 0x4C04 /* #10 'NSString' => 'Foundation.NSString, Xamarin.iOS' */ },
		{ NULL, 0x5104 /* #11 'Foundation_NSDispatcher' => 'Foundation.NSDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5204 /* #12 '__MonoMac_NSSynchronizationContextDispatcher' => 'Foundation.NSSynchronizationContextDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5304 /* #13 'Foundation_NSAsyncDispatcher' => 'Foundation.NSAsyncDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5404 /* #14 '__MonoMac_NSAsyncSynchronizationContextDispatcher' => 'Foundation.NSAsyncSynchronizationContextDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x5504 /* #15 'NSAutoreleasePool' => 'Foundation.NSAutoreleasePool, Xamarin.iOS' */ },
		{ NULL, 0x5D04 /* #16 'NSException' => 'Foundation.NSException, Xamarin.iOS' */ },
		{ NULL, 0x4804 /* #17 'NSDictionary' => 'Foundation.NSDictionary, Xamarin.iOS' */ },
		{ NULL, 0x300 /* #18 'AppDelegate' => 'model_2.AppDelegate, model_2' */ },
		{ NULL, 0x400 /* #19 'ViewController' => 'model_2.ViewController, model_2' */ },
		{ NULL, 0x5904 /* #20 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */ },
		{ NULL, 0 },
	};
	...
	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		{ 0x5E04 /* Foundation.INSObjectProtocol */, 0x5F04 /* NSObjectProtocolWrapper */ },
	};
